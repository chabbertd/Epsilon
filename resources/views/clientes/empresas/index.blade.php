...
<div class="card" style="margin-top: 30px;">
	...
	<div class="card-header text-center" style="padding: 5;">
	...
	<div class="card-body" style="padding: 5px;">
        <a href="{{ route('empresas.create') }}" class="btn btn-info btn-sm btnmodalcreateempresa"  style="float: left;" title="Nuevo sector">Nueva Empresa</a>		
		
		<table id="tblempresas" class="table table-striped table-sm" style="width:100%;">
        <thead>
            <tr>
                <th>Id</th>
                <th>Razón Social</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="modal-header-ins">
                <h5 class="modal-title" id="modal-title-ins">Nueva empresa</h5>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="modal-header-edit">
                <h5 class="modal-title" id="modal-title-edit">Editar empresa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
...
$('body').on('click', '.btnmodalcreateempresa', function (event) {
...
//$('#modal-btn-insert').click(function (event) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            swal({
                title : 'Nueva empresa',
                text : 'Se registró la nueva empresa exitosamente!',
                icon: 'success',
                button: "Cerrar",
            });
        },
            ...
            $.ajax({
                ...
                success: function (response) {  
                    ...
                    swal({
                        icon: 'success',
                        title: 'Eliminado',
                        text: 'Se ha eliminado la empresa en forma correcta.'
                    });
                },
                error: function (xhr) {
                    $('body').waitMe('hide');
