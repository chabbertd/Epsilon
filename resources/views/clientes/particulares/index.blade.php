...
@section('title','Clientes Particulares')
...
<div class="card" style="margin-top: 30px;">
	...
	<div class="card-body" style="padding: 5px;">
        <a href="{{ route('clientes.create') }}" class="btn btn-info btn-sm btnmodalcreateclientep"  style="float: left;" title="Nuevo sector">Nuevo cliente</a>
		
		
		<table id="tblclientesparticulares" class="table table-striped table-sm" style="width:100%;">
        <thead>
            <tr>
                <th>Id</th>
                <th>Nombre</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="modal-header-ins">
                <h5 class="modal-title" id="modal-title-ins">Nuevo cliente</h5>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="modal-header-edit">
                <h5 class="modal-title" id="modal-title-edit">Editar cliente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
...
$('#tblclientesparticulares').DataTable({
            scrollY: "80%",
            ...
            serverSide: true,
            pageLength: 25,
            ajax: "{{ route('get.clientesparticulares') }}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'apellidoynombre', name: 'apellidoynombre'},
                {data: 'cuit', name: 'cuit'},
...
$('body').on('click', '.btnmodalcreateclientep', function (event) {
...
//$('#modal-btn-insert').click(function (event) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#tblclientesparticulares').DataTable().ajax.reload();

            $('body').waitMe('hide');

            swal({
                title : 'Nuevo cliente',
                text : 'Se registró el nuevo cliente exitosamente!',
                icon: 'success',
                button: "Cerrar",
            });
        },
            ...
            $.ajax({
                ...
                success: function (response) {  
                    ...
                    swal({
                        icon: 'success',
                        title: 'Eliminado',
                        text: 'Se ha eliminado el cliente en forma correcta.'
                    });
                },
                error: function (xhr) {
                    $('body').waitMe('hide');
