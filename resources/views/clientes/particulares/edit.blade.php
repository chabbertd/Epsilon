{!! Form::model($model, [
						'route' => ['clientes.update', $model->id],
						'method' => 'PUT'
						]) !!}
						...
						<div class="form-group"  style="margin-bottom: 5px;">	
							{!! Form::label('apellidoynombre','Nombre y apellido(*)') !!}
							{!! Form::text('apellidoynombre', null, ['class' => 'form-control form-control-sm', 'id' => 'apellidoynombre', 'required']) !!}
						</div>
