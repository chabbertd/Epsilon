...
<div class="card" style="margin-top: 30px;">
	...
	<div class="card-header text-center" style="padding: 0;">
        ...
        <a href="{{ route('muestras.create') }}" class="btn btn-info btn-sm btnmodalcreatemuestra"  style="float: left; padding: 2px;" title="Nuevo tipo de muestra">Nuevo tipo de muestra</a>

		Listado de Tipos de Muestras
	...
	<div class="card-body" style="padding: 5px;">
		...
		<table id="tblmuestras" class="table table-striped table-sm" style="width:100%;">
        <thead>
            <tr>
                <th>Id</th>
...
<div class="modal fade" id="modal-ins" tabindex="-1" role="dialog" aria-labelledby="frm_ins_muestra" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header" id="modal-header-ins">
                <h5 class="modal-title" id="modal-title-ins">Nuevo tipo de muestra</h5>
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="frm_edit_muestra" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header" id="modal-header-edit">
                <h5 class="modal-title" id="modal-title-edit">Editar tipo de muestra</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
...
$('body').on('click', '.btnmodalcreatemuestra', function (event) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            swal({
                ...
                text : 'La muestra se actualizó exitosamente!',
                icon: 'success',
                button: "Cerrar",
            });
        },
...
$('body').on('click', '.btn-delete', function (event) {
    ...
    swal({
        ...
        text: 'Está seguro de eliminar el tipo de muestra?',
        icon: "warning",
        buttons: {
            cancel: "Cancelar",
            aceptar: true,
            ...
            $.ajax({
                ...
                success: function (response) {  
                    ...
                    swal({
                        icon: 'success',
                        title: 'Eliminado',
                        text: 'Se ha eliminado la muestra en forma correcta.'
                    });
                },
                error: function (xhr) {
                    $('body').waitMe('hide');
                    swal({
                        icon: 'error',
                        title: 'Error',
                        text: 'Ocurrió un error al intentar eliminar la muestra.'
                    });
                }
            });
        }
